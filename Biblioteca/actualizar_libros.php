    ...
    <form action="actualizar_libros.php" method="POST" class="row g-3 needs-validation pt-3" novalidate>
        ...
        <div class="col-md-2">
            ...
            <select class="form-control" id="ano_publ" name="ano_publ" required>
                <option value="<?php echo $row['ano_publ']; ?>"><?php echo $row['ano_publ']; ?></option>
                <?php while ($cont >= 1850) { ?>
        ...
        <div class="col-md-2">
            <label for="cantidad" class="form-label">ESTATUS</label>
            <input type="text" class="form-control" id="estatus" value="<?php echo $row['estatus']; ?>" name="estatus" required>
        </div>
        <div class="col-md-4">
