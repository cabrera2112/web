...
<option class="form-control" value="2">C</option>
<option class="form-control" value="2">D</option>
<option class="form-control" value="2">E</option>
...
<option selected disabled placeholder>Seleccione</option>
<option class="form-control" >Componente basico/Propedéutico</option>
<option class="form-control" >Técnico en Administración de Recursos
Humanos</option>
...
$sql ="INSERT INTO
usuarios(identificador,nocontrol_rfc,nom,ap,am,cel_usuario,sem,grupo,turno, especialidad)
